...
//                    downloadModel.setCurrentFileSize(totalBytesRead * 100);
//                    downloadModel.setTotalFileSize(responseBody.contentLength());
//                    downloadModel.setProgress((int) (totalBytesRead * 100 / responseBody.contentLength()));
//                    RxBus.getDefault().post(downloadModel);
                }
                return bytesRead;
            }
        };
